...
// 环境变量
const UUID = process.env.UUID || '69823e3d-cc65-4c73-9533-1430e7a5d918'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'shiwugouzi-dabao.hf.space';                   // 域名或ip,留空将自动获取服务器ip
