...
// 环境变量
const UUID = process.env.UUID || 'c15a2e39-40cb-461b-bdca-b75961484082'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'yydsyou-yyds.hf.space';                   // 域名或ip,留空将自动获取服务器ip
